...
class SyntheticGenObs_Controller(Sofa.Core.Controller):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if saveObservations:
            tool.addObject('VTKExporter', name='toolExp', filename=outputDir+'/tool.vtk',     position="@MO.position", listening="0" , XMLformat='0', exportAtBegin='1', exportEveryNumberOfSteps="0")
        ...
        if self.solver == 'Euler':
            ...
            simuNode.addObject('StaticSolver', name="NewtonStatic", printLog="0", absolute_correction_tolerance_threshold="1e-8", absolute_residual_tolerance_threshold="1e-8", should_diverge_when_residual_is_growing="1", newton_iterations="3")
        else:
        ...
        if self.linearSolver == 'CG':
            ...
            simuNode.addObject('SparseLDLSolver', template='CompressedRowSparseMatrixd', printLog="0")
        ...
        simuNode.addObject('RestShapeSpringsForceField', name='fixingSpring', stiffness='1e5', points='@FROI1.indices', springColor='0 1 0 1')
        simuNode.addObject('PointsFromIndices', template='Vec3d', name='FixedPoints', indices='@FROI1.indices')

        ### export observations
        if saveObservations:
            simuNode.addObject('VTKExporter', name='ObsExp', position="@MO.position", listening="1" , XMLformat='0', exportAtBegin="1", exportAtEnd='0', exportEveryNumberOfSteps="0", filename=outputDir+'/object.vtk', tetras='1', edges='0')
        ...
        mappedTool.addObject('TriangleSetTopologyContainer', name='MappedContainer', triangles="0 3 1 1 3 4 1 4 2 2 4 5 3 6 4 4 6 7 4 7 5 5 7 8")
        mappedTool.addObject('RestShapeSpringsForceField', name='toolSpring', stiffness='1e5', springColor='0 1 0 1', drawSpring='1', printLog='0', listening='1', external_rest_shape='@/tool/MO')
        ...
        if saveObservations:
            obsGrid.addObject('VTKExporter', name='observationExp', filename=monitorFile+'.vtk', position="@MO.position", listening="0" , XMLformat='0', exportAtBegin='1', exportEveryNumberOfSteps="0")
