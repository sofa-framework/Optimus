...
def createScene(rootNode):
    ...
    rootNode.createObject('RequiredPlugin', name='GeneralImplicitOdeSolver', pluginName='SofaGeneralImplicitOdeSolver')
...
class cyl3PartsRestShape_SDA(Sofa.PythonScriptController):
    ...
    def createGlobalComponents(self, rootNode):
        ...
        self.targetPoint = impactSimu.createObject('MechanicalObject', name="state", template='Vec3d', useTopology='false', position=self.options['impact_parameters']['position'])
        ...
        impactSimu.createObject('ShowSpheres', name="externImp", radius='0.005', color='1 0 1 1', position='@state.position')
