...
def createScene(rootNode):
    ...
    configFileName = "cyl3PartsConstForce_scene_config_bench.yml"
    #else:
    ...
    rootNode.addObject(cyl3PartsConstForceGenObs_Controller(name="cyl3PartsConstForce_GenObs", node=rootNode, opt=options))
    return 0;
