...
namespace component
{
	...
	extern "C" {
                SOFA_KalmanPlugin_API void initExternalModule();
                SOFA_KalmanPlugin_API const char* getModuleName();
                SOFA_KalmanPlugin_API const char* getModuleVersion();
                SOFA_KalmanPlugin_API const char* getModuleLicense();
                SOFA_KalmanPlugin_API const char* getModuleDescription();
                SOFA_KalmanPlugin_API const char* getModuleComponentList();
	}
