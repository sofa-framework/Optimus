...
strcParams.bodyID='cylinder152';
strcParams.problemType='forward';
strcParams.lagrangian='total';
strcParams.solutionMethod='full';
strcParams.experimentTag='_test2014';

%strcParams.bodyID='cylinder152_1G';
...
strcParams.directLoads=[0 0.0 0]; %these are added directly to the right-hand side for each node
...
visParams.fixedPointColor='blue';
visParams.presPointRestColor='cyan';
