...
strcParams.bodyID='cylinder152deformed1';

%main identificator of the output data (determines the name of output directory
strcParams.experimentTag='test_SVC_update4';
...
visParams.truthNodeFile='cylinder152deformed1/truth_nodes.mat';
visParams.truthFaceFile='cylinder152deformed1/faces.mat'; 
