...
strcParams.bodyID='cylinder1028deformed1';

%main identificator of the output data (determines the name of output directory
strcParams.experimentTag='test_SVC_inv4';
...
visParams.truthNodeFile='cylinder1028/nodes.mat';
visParams.truthFaceFile='cylinder1028/faces.mat'; 
