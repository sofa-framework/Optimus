...
namespace Verdandi
{
    ...
    protected:
        ...
        template<class T, class Allocator>
        void SetValue(string name, string constraint,
                      const std::vector<Seldon::Vector<T, VectFull, Allocator> >&
                      default_value,
                      bool with_default,
                      std::vector<Seldon::Vector<T, VectFull, Allocator> >& value);
        ...
        void SetValue(string name, string constraint,
                      const
                      std::vector<Seldon::Matrix<T, Prop, Storage, Allocator> >&
                      default_value,
                      bool with_default,
                      std::vector<Seldon::Matrix<T, Prop, Storage, Allocator> >&
                      value);
