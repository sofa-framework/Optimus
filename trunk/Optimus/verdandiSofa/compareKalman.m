...
indir='/home/ipeterlik/Work/Sofa/applications-dev/plugins/Optimus/verdandiSofa/scenes/result2_1673';
...
%figure; plot(1:nObs, R(:,nState-2), 1:nObs, R(:,nState-1), 1:nObs, R(:,nState));
