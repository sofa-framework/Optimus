...
class synth1_BCDA(Sofa.PythonScriptController):
    ...
    def createCommonComponents(self, node):
        ...
        if self.solver == 'Euler':
            ...
            node.createObject('StaticSolver', name="NewtonStatic", newton_iterations='3', correction_tolerance_threshold="1e-8", residual_tolerance_threshold="1e-8", should_diverge_when_residual_is_growing="1", printLog='0')
        else:
