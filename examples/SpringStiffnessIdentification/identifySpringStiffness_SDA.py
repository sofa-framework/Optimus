...
class SyntheticSDA_Controller(Sofa.Core.Controller):
    ...
    def createCommonComponents(self, node):
        ...
        node.addObject('RestShapeSpringsForceField', name="fixedSpring", drawSpring='1', points="@fixedBox1.indices", stiffness="@springStiffness.value", listening="1", printLog="0")
