...
class synth1_GenObs(Sofa.PythonScriptController):
    ...
    def createGraph(self, rootNode):
        ...
        if self.solver == 'Euler':
            ...
            simuNode.createObject('StaticSolver', name="NewtonStatic", newton_iterations='3', correction_tolerance_threshold="1e-8", residual_tolerance_threshold="1e-8", should_diverge_when_residual_is_growing="1", printLog='0')
        else:
        ...
        simuNode.createObject('RestShapeSpringsForceField', stiffness='1e5', name='fixingSpring', points='@FROI1.indices', springColor='0 1 0 1')
        if self.linearSolver == 'Pardiso':
        ...
        if saveObservations:
            simuNode.createObject('VTKExporter', position="@MO.position", listening="1" , XMLformat='0', exportAtBegin="1", exportAtEnd='0', exportEveryNumberOfSteps="0", filename=outputDir+'/object.vtk', tetras='1', edges='0')
        ...
        self.toolSprings=mappedTool.createObject('RestShapeSpringsForceField', stiffness='1e5', name='toolSpring', springColor='0 1 0 1', drawSpring='1', printLog='0', listening='1', external_rest_shape='@/tool/MO')
