...
public:
     ...
     */
    PointProjection(sofa::component::topology::TriangleSetTopologyContainer &_topology) : topology(_topology) {}
     ...
     */
    static void ComputeBaryCoords(Vec3 &baryCoords, const Vec3 &p,
     ...
     * @param bConstraint   Constraint coordinates to lie inside triangle.
     */
    static void ComputeBaryCoords(Vec3 &baryCoords, const Vec2 &p,
     ...
     */
    Real FindClosestPoint(Index& closestVertex, const Vec3& point, const VecVec3 &inVertices);
     ...
     */
    Real FindClosestEdge(Index& closestEdge, const Vec3& point, const VecVec3 &inVertices,
     ...
     */
    Real FindClosestTriangle(Index& closestTriangle, const Vec3& point,
...
protected:
    ...
    void ProjectPoint(Vec3 &baryCoords, Index &triangleID, Coord &projectedCoord, const Vec3 &point,
                      const VecVec3 &x, Index closestVertex, Index closestEdge, Index closestTriangle,
