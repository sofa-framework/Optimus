...
#ifndef SOFA_FLOAT
template class SOFA_GENERAL_ENGINE_API Indices2ValuesTransformer<Vec3dTypes>;
#endif //SOFA_FLOAT
#ifndef SOFA_DOUBLE
template class SOFA_GENERAL_ENGINE_API Indices2ValuesTransformer<Vec3fTypes>;
#endif //SOFA_DOUBLE
