...
******************************************************************************/
#ifndef UKMAPPEDSTATEOBSERVATIONMANAGER_H_
#define UKMAPPEDSTATEOBSERVATIONMANAGER_H_
...
class UKMappedStateObservationManager: public sofa::component::stochastic::ObservationManager<FilterType>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE3(UKMappedStateObservationManager, FilterType, DataTypes1, DataTypes2), SOFA_TEMPLATE(ObservationManager, FilterType));
...
public:
    ...
    SingleLink<UKMappedStateObservationManager<FilterType, DataTypes1, DataTypes2>, StateWrapper, BaseLink::FLAG_STOREPATH|BaseLink::FLAG_STRONGLINK> stateWrapperLink;
...
#endif // UKMAPPEDSTATEOBSERVATIONMANAGER_H
