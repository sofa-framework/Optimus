...
SOFA_DECL_CLASS(VerdandiObservationParams)

int VerdandiObservationParamsClass = core::RegisterObject("Parameters that will be adapted by ROUKF object")
        .add< VerdandiObservationParams >()
        ;

VerdandiObservationParams::VerdandiObservationParams()
    : Inherit()
