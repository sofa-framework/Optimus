...
To summarize, Optimus plugin allows for estimation or identification of any quantity that can be \emph{fed} to a SOFA component, be it a state, control (force) and parameters.
