...
############################"
    ...
    def createGlobalComponents(self, node):
        ...
        toolEmu.createObject('PreStochasticWrapper',name="PreStochasticWrap",verbose="1")
    ...
    def createCommonComponents(self, node):
        ...
        node.createObject('StaticSolver', name="NewtonStatic", correction_tolerance_threshold="1e-8", residual_tolerance_threshold="1e-8", should_diverge_when_residual_is_growing="1",  newton_iterations="1", printLog='1')
        ...
        node.createObject('SparsePARDISOSolver',name="precond",symmetric="2",exportDataToDir="",iterativeSolverNumbering="1")
        ...
        node.createObject('RestShapeSpringForceField', name="fixedSpring", points="@fixedBox1.indices", stiffness="@springStiffness.value", springThickness="1", listening="1", printLog="0")
        ...
        toolMapped.createObject('RestShapeSpringForceField', name="toolSpring", stiffness="1e5", external_rest_shape="../../toolEmu/MO", springThickness="1", listening="1", springColor="0 1 0 1")
    ...
    def createScene(self, node):
        ...
        for i in range(1,self.m_slaveSceneCount):
            slave=node.createChild('SlaveScene_'+str(i))
