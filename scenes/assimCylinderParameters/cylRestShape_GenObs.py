...
class cylGravity_GenObs (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):
        ...
        simuNode.createObject('VariationalSymplecticSolver', rayleighStiffness=self.options.model.rayleighStiffness, rayleighMass=self.options.model.rayleighMass, newtonError='1e-12', steps='10', verbose='0')
