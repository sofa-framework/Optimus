...
class synth1_BCDA(Sofa.PythonScriptController):
    ...
    def createGraph(self,node):          
        ...
        self.paramInitExp = 3000.0
        self.paramInitSD = 1000
        self.obsInitSD= 1e-3
    ...
    def createCommonComponents(self, node):                                  
        ...
        node.createObject('BoxROI', name='fixedBox1', box='-0.001 -0.001 -0.001 0.015 0.001 0.001', drawBoxes='1')
        ...
        self.toolSprings=toolMapped.createObject('ExtendedRestShapeSpringForceField', name="toolSpring", stiffness="5000", external_rest_shape="../toolEmu/MO", springThickness="1", listening="1", updateStiffness="1", springColor="0 1 0 1",startTimeSpringOn="0",numStepsSpringOn="10000")
