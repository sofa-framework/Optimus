...
class synth1_BCDA(Sofa.PythonScriptController):
    ...
    def createCommonComponents(self, node):                                  
        ...
        self.toolSprings = node.createObject('RestShapeSpringsForceField', name="impactSpring", stiffness="4", angularStiffness='1', external_rest_shape='@externalImpSimu/state', points='@impactBounds.indices')
