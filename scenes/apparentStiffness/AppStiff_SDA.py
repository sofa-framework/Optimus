...
class AppStiff_SDA(Sofa.PythonScriptController):
    ...
    def createGraph(self, rootNode):
        ...
        if 'prescribed_displacement' in self.opt['model'].keys():
            ...
            simuNode.createObject('RestShapeSpringForceField', name='toolSpring', stiffness=self.opt['model']['prescribed_displacement']['spring_stiffness'], springColor='0 1 0 1', drawMode='1', printLog='0', listening='1', external_rest_shape='../phant/MO', points='@prescDispBox.indices', external_points='@prescDispBox.indices', showIndicesScale=0.0)
        ...
        if self.saveData > 1:
            ...
            obsNode.createObject('OptimMonitor', name='ObservationMonitor', indices='@observationBox.indices', fileName=self.errFile, ExportPositions='1', ExportVelocities='0', ExportForces='0',  exportOnEvent='2', printLog='0')
