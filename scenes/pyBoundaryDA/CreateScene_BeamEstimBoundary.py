...
############################"
    ...
    def createGlobalComponents(self, node):
        ...
        node.createObject('RequiredPlugin', pluginName='SofaMJEDFEM', name='SofaMJEDFEM')
    ...
    def createCommonComponents(self, node):  
        ...
        # node.createObject('MJEDTetrahedralForceField', materialName="StVenantKirchhoff",ParameterSet="3.4483e+04 3.1034e+05")
