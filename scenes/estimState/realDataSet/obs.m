...
o3d = dlmread('/home/raffa/work/data_optimus/Raffa/p3d/sample5/all5.p3d');
...
B(i,19:21)=0.001*o3d(i,19:21)*roty(-pi/2);
B(i,22:24)=0.001*o3d(i,22:24)*roty(-pi/2);
B(i,25:27)=0.001*o3d(i,25:27)*roty(-pi/2);
B(i,28:30)=0.001*o3d(i,28:30)*roty(-pi/2);
B(i,31:33)=0.001*o3d(i,31:33)*roty(-pi/2);
