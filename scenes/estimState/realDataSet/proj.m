...
%   
%  for i =1:ms
%       rx = P(1,1) * pos(i,31) + P(1,2) * pos(i,32) + P(1,3) * pos(i,33) + P(1,4);
%       ry = P(2,1) * pos(i,31) + P(2,2) * pos(i,32) + P(2,3) * pos(i,33) + P(2,4);
%       rz = P(3,1) * pos(i,31) + P(3,2) * pos(i,32) + P(3,3) * pos(i,33) + P(3,4);
%       pos2d(i,21)=rx* (1.0/rz);
%       pos2d(i,22)=ry* (1.0/rz);    
%                
%   end 
