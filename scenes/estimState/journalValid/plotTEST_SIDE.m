...
figure
plot(TEST_SIDE_RMSE_0*1000)
hold on
plot(TEST_SIDE_RMSE_1*1000, 'Color',[1 0 0])
hold on
plot(TEST_SIDE_RMSE_2*1000, 'Color',[0 0.8 0])
hold on
plot(TEST_SIDE_RMSE_3*1000, 'Color',[1 0 1])
grid on
...
figure
plot(TEST_SIDE_RMSE2d_0, 'Color',[1 0 0])
hold on
plot(TEST_SIDE_RMSE2d_1, 'Color',[1 0 0]) 
hold on
plot(TEST_SIDE_RMSE2d_2, 'Color',[0 0.8 0])
hold on
plot(TEST_SIDE_RMSE2d_3, 'Color',[1 0 1])
grid on
xlabel('h - [simulation step]') % x-axis label
...
figure
plot(TEST_SIDE_hd_0*1000)
hold on
plot(TEST_SIDE_hd_1*1000, 'Color',[1 0 0])
hold on
plot(TEST_SIDE_hd_2*1000, 'Color',[0 0.8 0])
hold on
plot(TEST_SIDE_hd_3*1000, 'Color',[1 0 1])
grid on
xlabel('h - [simulation step]') % x-axis label
...
figure
plot(TEST_SIDE_hd2d_0)
hold on
plot(TEST_SIDE_hd2d_1, 'Color',[1 0 0])
hold on
plot(TEST_SIDE_hd2d_2, 'Color',[0 0.8 0])
hold on
plot(TEST_SIDE_hd2d_3, 'Color',[1 0 1])
grid on
xlabel('h - [simulation step]') % x-axis label
