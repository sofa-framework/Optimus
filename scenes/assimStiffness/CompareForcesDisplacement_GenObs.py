...
class AppliedForces_GenObs (Sofa.PythonScriptController):
    ...
    def createGraph(self,rootNode):        
        ...
        if self.opt['model']['linsol']['usePCG']:
        	simuNode.createObject('StepPCGLinearSolver', name='lsolverit', precondOnTimeStep='1', use_precond='1', verbose='0', preconditioners='lsolver', listening='1',
        	 tolerance=mopt['linsol']['PCGTolerance'], update_step=mopt['linsol']['PCGUpdateSteps'], iterations=mopt['linsol']['PCGTolerance'])
        ...
        simuNode.createObject('TetrahedronFEMForceField', updateStiffness='1', name='FEM', listening='true', 
            drawHeterogeneousTetra='1', method=self.opt['model']['fem_method'], poissonRatio='0.45', youngModulus='@youngMapper.outputValues')
