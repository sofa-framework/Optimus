...
class pigLiver1_BCDA(Sofa.PythonScriptController):
    ...
    def createGlobalComponents(self, node):
        ...
        features.createObject('BoxROI', name="ObsIx", box='320 120 -10 390 160 10   280 200 -10 320 280 10    510 260 -10   550 280  10    330 320 -10  350 340 10', drawBoxes='1')
    ...
    def createCommonComponents(self, node):                           
        ...
        self.toolSprings=mappedTool.createObject('ExtendedRestShapeSpringForceField', external_rest_shape='/features/MO', numStepsSpringOn='10000', stiffness='1e5', name='toolSpring', springColor='0 1 0 1', drawSpring='1', updateStiffness='1', printLog='0', listening='1', angularStiffness='0', startTimeSpringOn='0')
