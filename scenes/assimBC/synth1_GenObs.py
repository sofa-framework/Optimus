...
class synth1_GenObs (Sofa.PythonScriptController):    
    ...
    def createGraph(self,rootNode):
        ...
        if saveObservations:
            ...
            tool.createObject('Monitor', name=outputDir+'/tool', showPositions='1', indices="@toolDOFs.indices", ExportPositions="1", ExportVelocities="1", ExportForces="1")
        ...
        simuNode.createObject('BoxROI', box='-0.001 -0.001 -0.011 0.025 0.001 0.001', drawBoxes='1', name='FROI1')
        ...
        simuNode.createObject('ExtendedRestShapeSpringForceField', stiffness='1e5', name='fixingSpring', points='@FROI1.indices', springColor='0 1 0 1', startTimeSpringOn='0', numStepsSpringOn='10000')
        ...
        if saveObservations:
            ...
            obsGrid.createObject('Monitor', name=monitorFile, indices="@gridDOFs.indices", ExportPositions="1", ExportVelocities="0", ExportForces="0")
